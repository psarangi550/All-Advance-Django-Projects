"""
Django settings for IntegrateFbLikeCommentBlogProj project.
...
SECRET_KEY = 'y3@n6l*uybuq^0@_j#0$3)=&@)y1&a25!_-5zels+)*-!kafp2'
...
ROOT_URLCONF = 'IntegrateFbLikeCommentBlogProj.urls'
...
WSGI_APPLICATION = 'IntegrateFbLikeCommentBlogProj.wsgi.application'
